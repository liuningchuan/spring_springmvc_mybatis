...
import com.liuning.controller.validation.ValidGroup1;
import com.liuning.exception.CustomException;
...
// 比如：商品列表查询：/items/queryItems.action
...
public class ItemsController {
	...
	public Map<String, String> getItemTypes() {
		...
		itemTypes.put("101", "笔记本");
		itemTypes.put("102", "手机");
		itemTypes.put("103", "背包");
	...
	//提交更新信息（pojo类型绑定）传入的参数会自动与ItemsCustom中名称相同的成员变量绑定
	...
	public String editItemsSubmit(
		...
		if(items_pic != null && originalFilename != null && originalFilename.length() > 0){	
			//存储图片的物理路径
			String pic_path = "D:\\Java\\workspace\\springmvc_mybatisQuickStart\\WebRoot\\images\\";
			//新的图片名称
